...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        private bool CheckDuplicateBindings(InputAction action,int bidingIndex,bool allCompositeParts=false)
        {
            InputBinding newBinding = action.bindings[bidingIndex];
