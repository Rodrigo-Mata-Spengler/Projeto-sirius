...
public class ScreenSpaceOutlines : ScriptableRendererFeature
{
    ...
    private class ScreenSpaceOutlineSettings
    {
        ...
        [Range(0.0f, 100.0f)]
        public float depthThreshold = 8.3f;
        [Range(0.0f, 500.0f)]
    ...
    private class ViewSpaceNormalsTexturePass : ScriptableRenderPass
    {
        ...
        public ViewSpaceNormalsTexturePass(RenderPassEvent renderPassEvent, LayerMask layerMask, LayerMask occluderLayerMask, ViewSpaceNormalsTextureSettings settings)
        {
            ...
            normalsMaterial = new Material(Shader.Find("Shader Graphs/ViewSpaceNormals"));
    ...
    public override void Create()
    {
        ...
        viewSpaceNormalsTexturePass = new ViewSpaceNormalsTexturePass(renderPassEvent, outlinesOccluderLayerMask, outlinesLayerMask, viewSpaceNormalsTextureSettings);
